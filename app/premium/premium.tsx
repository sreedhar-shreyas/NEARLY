...
const Premiums: React.FC = () => {
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-2xl sm:text-center">
      ...
      <p className="mt-6 text-lg leading-8 text-gray-600">Discover premium features for an enhanced roommate-finding journey. Benefit from advanced matching, boosted profile visibility, and priority support. Elevate your experience and connect with the ideal roommate effortlessly.</p>
    </div>
