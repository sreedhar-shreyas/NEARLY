        ...
        <div className="bg-white rounded-lg shadow m-4 dark:bg-white-800">
            ...
            <div className="contactDetails py-4 lg:py-8 flex flex-col lg:flex-row lg:justify-between">
                <div className="email text-center flex flex-col items-center mb-4 lg:mb-0">
                    ...
                    <div className='emaildiscription text-lg'>Send us an email, and well get back to you promptly</div>
            ...
            <div className="connectsection py-10 flex flex-col lg:flex-row lg:justify-between">
                    ...
                    <div className="list">
                        <ul className="list-none p-0">
                            <li className="icon py-1 text-blue-500">
                                <a href="#" className="ml-2">About</a>
                            </li>
                            <li className="icon py-1 text-blue-500">
                                <a href="#" className="ml-2">Contact</a>
                            </li>
                            <li className="icon py-1 text-blue-500">
                                <a href="#" className="ml-2">Link one</a>
                            </li>
                            <li className="icon py-1 text-blue-500">
                                <a href="#" className="ml-2">Link one</a>
                            </li>
